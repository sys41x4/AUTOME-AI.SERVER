...
try:
    ...
    ftp_max_conn = SERVER_CONFIG_DATA["FTPS_info"]["max_conn"]
    ftp_max_conn_per_ip = SERVER_CONFIG_DATA["FTPS_info"]["max_conn_per_ip"]
except:
    pass
...
try:
    with open(BASE_CONFIG_DATA["config_filePath"]["USER"], 'r') as f:
        print(BASE_CONFIG_DATA["config_filePath"]["USER"])
        USERS_ACCESS_CONFIG_DATA = json.load(f)
...
def main():
    ...
    server.max_cons = ftp_max_conn
    server.max_cons_per_ip = ftp_max_conn_per_ip
